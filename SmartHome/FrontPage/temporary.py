...
## load stuff 
    ...
    with open('../models/mallet_test_a1.pkl', 'rb') as mallet_mods:
        gensim_mods = pickle.load(mallet_mods)
    ...
    print("Calculate Coherence gensim cv in {}...")
    coherencemodel = CoherenceModel(model = gensim_mods, texts = texts,
    ...
    with open('../evaluation/models_mallet_test.pkl', 'wb') as models_c_v:
